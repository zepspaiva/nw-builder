...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.19.0': ['nw.exe', 'ffmpeg.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak', 'nw.dll', 'locales', 'd3dcompiler_47.dll', 'natives_blob.bin', 'node.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'nw_elf.dll', 'resources.pak', 'snapshot_blob.bin']
        },
